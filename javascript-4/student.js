...
// CODE HERE
const faveColors = ['red', 'blue', 'yellow']
//////////////////Step 2////////////////////
...
const me = {
    firstName: "Caden",
    superHeroName: "Cade-Exotic",
    homeTown: "South Jordan",
    superPowers: ["Blame that b**** Carole Baskin", "Tiger Call", "Mullet Whip"],
    superPowerXP: () => Math.floor(Math.random() * 100) + 1,
    profileImage: () => {
        return 'https://tr.rbxcdn.com/35d68778c4ed8cf0e71de0bcbd962598/420/420/Decal/Png'
    }
}
